...
ELASTICSEARCH_HTTP_SCHEME = get_env_variable("ESSCHEME")
ELASTICSEARCH_HOSTS = [{"scheme": ELASTICSEARCH_HTTP_SCHEME, "host": ELASTICSEARCH_HTTP_HOST, "port":  ELASTICSEARCH_HTTP_PORT}]
